                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="row">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" autofocus required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="employee_id" type="text" class="form-control @error('employee_id') is-invalid @enderror" name="employee_id" value="{{ $user->employee_id }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="position" type="text" class="form-control @error('position') is-invalid @enderror" name="position" value="{{ $user->position }}" required>
                                ...
                                <div class="col-md-6">
                                    <select id="address_id" class="form-control @error('address_id') is-invalid @enderror" name="address_id" required>
                                        ...
                                        @foreach ($addresses as $key => $value)
                                            <option value="{{ $key }}" {{ $user->address_id === $key ? 'selected' : '' }}> 
                                                {{ $value }} 
                                            </option>
                                        @endforeach    
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <select id="roles" class="form-control @error('roles') is-invalid @enderror" name="roles" multiple required>
                                        @foreach ($roles as $key => $value)
                                            <option value="{{ $key }}" {{ $userRoles === $key ? 'selected' : '' }}> 
                                                {{ $value }} 
                                            </option>
                                        @endforeach    
                                    </select>
